...
class ParticleBoxF(_object):
    ...
    def ComputeEnergy(self, *args): return _moldyn.ParticleBoxF_ComputeEnergy(self, *args)
    def Solve(self, steps=25): return _moldyn.ParticleBoxF_Solve(self, steps)
    def WriteData(self, *args): return _moldyn.ParticleBoxF_WriteData(self, *args)
...
class ParticleBoxD(_object):
    ...
    def ComputeEnergy(self, *args): return _moldyn.ParticleBoxD_ComputeEnergy(self, *args)
    def Solve(self, steps=25): return _moldyn.ParticleBoxD_Solve(self, steps)
    def WriteData(self, *args): return _moldyn.ParticleBoxD_WriteData(self, *args)
